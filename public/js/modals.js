...
function showPersonnelRecordModal(emp, editRecord) {
  // Delegate to the improved showPersonnelModal in leavecard-form.js
  if (typeof showPersonnelModal === 'function') {
    showPersonnelModal(emp, editRecord);
    return;
  }
 
  // Fallback — should not reach here if leavecard-form.js is loaded
  console.warn('[modals] showPersonnelModal not found — ensure leavecard-form.js is loaded first.');
}
